...
namespace RobonautCasparClient_v2.Modules.interfaces
{
    public abstract class IGraphicsServerInteractor
    {
        ...
        */
         ...
         */
        public abstract void showFullscreenGraphics(FullScreenTableType type, List<(int rank, TeamData teamData)> teamDatasWithRanks, int lastThisMany);
         ...
         */
        public abstract bool stepFullScreenGraphics(List<(int rank, TeamData teamData)> teamDatasWithRanks, int lastThisMany);
